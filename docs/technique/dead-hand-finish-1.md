...
It is one of the most advanced expressions of the [Absorb](absorb.md) principle because the absorption happens within a stroke that, to the opponent, looks like full power.
...
The Dead-Hand Finish and [Drop Volley](drop-volley.md) are mechanically related but contextually different:
...
The opponent's anticipation system (built on pattern recognition of body position, take-back depth, and swing arc) has already committed to reading a full groundstroke before the deceleration phase begins. The [L-Shape Integrity](l-shape-integrity.md) of the wrist is maintained until contact, so no postural cue reveals the shot.
...
1. Without a ball, the player executes their full forehand or backhand swing motion **ten times**
2. Deceleration occurs only in the **final 30 centimetres** of the arc each time
3. A partner stands at the net watching and calls out the moment they detect the deceleration
4. The goal: the partner cannot detect the deceleration until the ball would already be in the Deceleration Zone
5. **Transfer to live balls only when the shadow pass-rate is above 80%**
...
Executing this shot under fatigue or stress risks the [Kinetic Chain](../biomechanics/kinetic-chain.md) failing and the braking forces landing in the arm.
