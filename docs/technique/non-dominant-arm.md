...
During the [Coil](coil.md) phase, the non-dominant hand stays on the throat of the racket. This serves two functions:
1. It physically guides the racket into the correct back-fence position
2. It ensures the unit turn is driven by both arms together, maximising shoulder rotation depth and [X-Factor](x-factor.md) loading
