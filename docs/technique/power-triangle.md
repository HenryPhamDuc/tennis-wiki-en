...
The "Power Triangle" is formed by:
- The **upper arm** from shoulder to elbow
- The **forearm** from elbow to wrist
- The **racket handle** from wrist to strings
...
This move:
- Destroys the Power Triangle's structural geometry
- Removes body weight contribution completely
- Forces the ball to be hit entirely with the arm's small muscles
- Produces a weak, "floated" return
