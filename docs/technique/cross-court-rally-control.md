---
title: "Cross-Court Rally Control"
language: en
...
The cross-court forehand at this pace level:
- Pins the opponent behind their baseline
- Prevents angle creation (the opponent cannot angle sharply from a deep, defensive position)
- Accumulates positional pressure over multiple shots
...
Neutralisation is not defensive. It is strategic patience. The neutralisation mindset accepts that not every shot can be an attack, and that consistently neutralising from pressure creates more forehand opportunities than forcing aggression from bad positions. See [Neutralisation Mindset](neutralisation-mindset.md).
