...
The Pinpoint Stance is a serve preparation stance in which the back foot slides forward to meet the front foot during the trophy position phase, creating a narrow base that concentrates the [Vertical GRF](vertical-grf.md) into a single explosive upward drive.
...
The narrowing creates the conditions for a more aggressive [Vertical GRF](vertical-grf.md) — a higher launch position, a more explosive upward drive, and contact at maximum extension.
