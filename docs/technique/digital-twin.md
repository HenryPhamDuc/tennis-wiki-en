...
These simulations don't produce certainties — they produce probability distributions that inform the [Pattern Mapping](../tactics/pattern-mapping.md) session before the match.
...
- [Error-Tendency Heatmaps](../tactics/error-tendency-heatmaps.md)
- [HRV Load Management](../psychology/hrv-load-management.md)
