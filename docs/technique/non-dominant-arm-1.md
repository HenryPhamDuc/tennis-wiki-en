...
Traditional coaching treats the non-dominant arm as secondary — "soft hands," a balancing tool, something to keep out of the way. Elite biomechanics shows the opposite: in a [Unified Bilateral System](unified-bilateral-system.md), the two arms operate in geometric opposition, tethered by a continuous line of elastic tension. If one hand moves, the other must mathematically compensate.
...
- See [One-Handed Backhand Counter-Balance](one-handed-backhand-counter-balance.md) for the full mechanics
...
### Serve
- The tossing arm functions as the rotational regulator for shoulder tilt and cartwheel axis — see [Tossing Arm as Rotational Regulator](../players/tossing-arm-as-rotational-regulator.md)
- Points directly at the incoming ball during the trophy position as a "spatial anchor" (Radar Arm) — see [Radar Arm](radar-arm.md)
