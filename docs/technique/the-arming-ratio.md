...
The **Arming Ratio** is the primary diagnostic test for detecting [Arming](arming.md) in the forehand. It answers a single, measurable question: *does the racket head accelerate before the hips have cleared?*

If the hand passes the plane of the back hip before the navel has turned to face the net, the [Stretch-Shortening Cycle](stretch-shortening-cycle.md) has failed. The player is pulling with the shoulder rather than whipping from the core. This is the first fault to identify and correct in any forehand analysis.
...
The hip clearance moment is the most precise indicator of [X-Factor](x-factor.md) sequencing because it is the exact instant when the torso's rotational energy becomes available to the arm. If the arm moves before that moment, there is no torso energy to receive — the arm is operating alone.

The navel-to-net orientation marks the completion of the pelvic rotation phase. Before this point:
- The [Stretch-Shortening Cycle](stretch-shortening-cycle.md) is still loading
- The elastic tension across the anterior oblique sling is at maximum
- The arm should still be in the slot, trailing behind

After this point:
- The torso begins to uncoil
- The arm is pulled forward by the chain (not muscled by the shoulder)
- The wrist can release passively at the end of the arc
...
The Arming Ratio is simultaneously a diagnostic for [Stretch-Shortening Cycle](stretch-shortening-cycle.md) failure. When the arm accelerates before hip clearance:
...
1. Observe the stroke in real time or on video
2. Apply the Arming Ratio test: does the hand lead the hips?
3. If yes — diagnose arming; prescribe core sequencing work, not arm or follow-through instruction
4. If no — proceed to secondary diagnostics (contact compression, wrist position, etc.)
