...
It is the primary coaching diagnostic for the [One-Handed Backhand (1HBH)](one-handed-backhand-(1hbh).md).
...
Scapular retraction is the upper-body expression of the [X-Factor (Shoulder-Hip Separation)](x-factor-(shoulder-hip-separation).md) coil. At maximum backswing, the non-dominant arm holds the racket throat and the non-dominant shoulder is pulled forward (into the coil). As the forward swing begins, the hitting arm fires forward while the non-dominant shoulder *pulls back* — maintaining the X-Factor differential for as long as possible into the forward swing.
...
A specific training drill for the counterweight mechanism:
- The player holds a resistance band in their non-dominant hand, anchored to the fence behind them.
- They shadow-swing (or hit soft feeds) a one-handed backhand.
- Upon contact, they must pull the resistance band backward with the non-dominant hand.
- **The constraint**: if the chest rotates to face the net, the player fails. They must finish sideways, arms forming a straight "V" line from shoulder to shoulder.
