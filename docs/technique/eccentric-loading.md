...
Eccentric Loading is the phase in which muscles lengthen *under active tension* — the muscle is contracting but being stretched longer by an external force (gravity, momentum, or body weight). It is the first phase of the [Stretch-Shortening Cycle (SSC)](stretch-shortening-cycle-(ssc).md) and the mechanism by which elastic potential energy is stored in tendons for explosive release.

In tennis, Eccentric Loading occurs in every [Triple Flexion](triple-flexion.md) descent: the ankle flexors, knee extensors, and hip flexors stretch under the weight of the body as the player lowers into the loaded spring position.
...
The demands on the lower body are substantial:
- Split-step landings: body weight absorbed through ankle-knee-hip Eccentric Loading
- Wide lateral reaches: the outside leg absorbs the player's full lateral momentum eccentrically
- Serve loading (Trophy position): quadriceps and glutes loaded eccentrically as the player sinks into [Triple Flexion](triple-flexion.md)
- Hard-court deceleration: G-forces reaching **5x body weight** managed through eccentric strength of the quads and glutes
...
**Excessive Load Duration (SSC Violation)**: Holding the eccentric position too long (> 150ms in the [Amortization Phase](amortization-phase.md)) allows the stored energy to dissipate as heat. The effort of the eccentric load is wasted.
