...
The early 2000s coaching model treated the [X-Factor](x-factor.md) as a static measurement — how far apart the hips and shoulders were at the top of the backswing. The correct configuration was taught as: finish the shoulder turn, then uncoil.
...
1. The hips begin rotating toward the net
2. The shoulders are still loading backward
3. For a brief moment, the hips and shoulders are moving in opposite directions simultaneously — the body is being "pulled apart"
4. This simultaneous opposing stretch loads the obliques, deep core muscles, and thoracolumbar fascia to a degree impossible through sequential coil-then-uncoil
...
This is the [Delayed Hip-Shoulder Separation](../biomechanics/delayed-hip-shoulder-separation.md) described in the Alcaraz vault, seen here through the coaching methodology lens.

## The Time-Lag Rule

Each segment in the chain launches the next *before completing its own movement*:
- Hips begin rotating before shoulders have finished loading
- Shoulders begin forward movement before hip rotation is complete
- Arm fires before shoulder has stopped
- At each handoff, speed accumulates
...
**The medicine ball slingshot drill** is the most effective physical tool for teaching Separation Timing:
- Player holds a medicine ball at chest height
- Rotates hips as far as possible and *pauses*
- Then allows the shoulders and arms to follow naturally
...
- [Viscoelastic Engine](../biomechanics/viscoelastic-engine.md)
