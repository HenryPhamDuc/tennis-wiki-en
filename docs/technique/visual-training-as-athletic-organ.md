---
title: "Visual Training as Athletic Organ"
language: en
...
| **Saccadic** | Rapid jump between fixed points | Very fast — but ballistic (cannot be mid-flight corrected) | [Predictive Saccades](predictive-saccades.md) — jump to anticipated contact zone |
...
See [Coaching the Return](coaching-the-return.md) — 15 minutes reading serves before live returning activates anticipatory visual system. Pure visual training within existing session structure.
