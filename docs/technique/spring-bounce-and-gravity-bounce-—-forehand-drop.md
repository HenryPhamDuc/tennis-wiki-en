---
title: "Spring-Bounce and Gravity Bounce — Forehand Drop"
language: en
...
The wall-rebound drill is the most reliable teaching tool for the SSC feel that underlies the spring-bounce:
1. Player stands two metres from a wall
2. Bounces a medicine ball into the wall at waist height
3. Catches and immediately rebounds it — no pause between catch and throw
4. The no-pause rebound forces the body to use elastic energy rather than muscular reset
