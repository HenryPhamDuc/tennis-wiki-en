...
It is the signature expression of [Initiative Stealing](initiative-stealing.md) and the shot that most concretely defines Alcaraz as the 2026 game's creative improvisation standard.
...
1. **Maintains full swing preparation** through 90% of the motion — the unit turn, the load, the forward swing initiation are indistinguishable from a driving ball
2. **Decelerates the racket and softens the hands** in the final 30cm of the swing
3. **Produces a ball that lands near the net** — the opposite of what the opponent's kinematic preparation is calibrated for
