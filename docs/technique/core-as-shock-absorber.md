...
### Lower Back: [Braking Failure](../biomechanics/braking-failure.md)
...
### The Solution
Not rest. **Training the core to decelerate as explosively as it accelerates.** This is a form of [Eccentric Deceleration](eccentric-deceleration.md) applied to the trunk — the core must be capable of a rapid, forceful eccentric contraction to arrest rotation at the correct moment.
...
At modern forehand speeds (racket heads regularly exceeding 130 km/h), the rotational momentum of the [Kinetic Chain](../biomechanics/kinetic-chain.md) must be safely absorbed after the ball leaves the strings. *"The arm cannot simply stop. The energy must be redirected somewhere."* That somewhere is the core — and if the core is unavailable, it goes to the shoulder and elbow.
