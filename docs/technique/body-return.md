...
It is a tactical application of the [Plus-One Principle](plus-one-principle.md) from the returner's perspective — designed to neutralise the server's third-ball weapon before it can be struck.
...
Either outcome benefits the returner:
- The jammed swing produces a short, weak ball the returner can attack
- The step-around opens the court for a directional winner
...
The Body Return is explicitly a counter to the [Plus-One Principle](plus-one-principle.md) as applied from the serve side: it jams the server's plus-one forehand at its source. Rather than allowing the server to dictate with their pre-designed third ball, the body return eliminates the third ball's power before it happens.
