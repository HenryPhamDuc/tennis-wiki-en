...
The Straight-Arm Forehand is a forehand technique in which the hitting elbow is fully extended at the moment of ball contact, maximising the radius (r) of the swing arc and thereby generating the highest possible tangential racket-head velocity from a given angular velocity of the trunk.
...
At elite level, Alcaraz rotates his shoulders nearly 100° while the hips rotate only 45° — and then releases the full torque through a maximally extended arm. By the time the racket reaches the ball, it has been accelerated through five sequential launches up the [Kinetic Chain](../biomechanics/kinetic-chain.md), arriving at the contact zone with the arm at full extension.
...
Alcaraz's straight-arm is preceded by the [High-Elbow Backswing](high-elbow-backswing.md) — where the elbow points outward and backward at a relatively high angle during the initial turn — and passes through the [Gravity Drop](gravity-drop.md) before reaching full extension at contact. His [Lasso Finish](lasso-finish.md) (or "wiper" on faster balls) follows.

His elbow finishes higher than his eyes on heavy topspin balls — a diagnostic indicator of the deep [Gravity Drop](gravity-drop.md) and down-then-up trajectory that precedes the extension.
