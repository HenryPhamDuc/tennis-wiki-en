...
**Examples**:
- Calling out the colour or number on the incoming ball mid-rally
- Solving simple arithmetic problems (called aloud by the coach) during a live point
- Identifying the opponent's hip rotation direction before contacting the ball
- Responding to a coach's hand signal mid-swing to change the target zone
...
**Examples**:
- **Virtual game debt**: The player loses a "virtual game" if they fail to complete their full between-point ritual within 20 seconds. This creates time pressure without match-point stakes, but trains the ritual's execution under urgency
- **Consequence sets**: Points are played with exaggerated consequences for errors — physical penalties, score inversions, or public failure — to elevate emotional stakes and train regulatory capacity under that load
- **Clutch point blocks**: Coaching deliberately creates break point or match point simulations at high frequency, exposing the player to the amygdala trigger repeatedly until its activation threshold rises
...
**Examples**:
- Executing serve mechanics after a conditioning sprint sequence
- Running a technical groundstroke drill in the final minutes of a long physical session
- Playing competitive points after a 90-minute physical conditioning session
...
The most advanced CMT implementation uses wearable biofeedback to teach players to recognise the physiological markers of amygdala activation before it escalates to full [Petit Bras](petit-bras.md):
...
- **Stroboscopic glasses**: Train anticipatory processing by forcing the brain to build and act on incomplete predictions — building the predictive processing framework that underpins [Anticipation vs Reaction](anticipation-vs-reaction.md)
