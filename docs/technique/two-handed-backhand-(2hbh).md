---
title: "Two-Handed Backhand (2HBH)"
language: en
...
|---|---|
| [Non-Dominant Hand as Engine](non-dominant-hand-as-engine.md) | The defining insight: the left arm drives, not the right |
| [X-Factor (Shoulder-Hip Separation)](x-factor-(shoulder-hip-separation).md) | The coil that stores the torque driving both 1HBH and 2HBH |
| [One-Handed Backhand (1HBH)](one-handed-backhand-(1hbh).md) | The tactical alternative: more reach, variety, and disguise |
| [Backhand Grips](backhand-grips.md) | Eastern, Semi-Western, Continental — how grip shapes stroke type |
| [Contact Geometry](contact-geometry.md) | How far in front the ball is struck differs fundamentally by type |
| [Backhand Slice](backhand-slice.md) | The tactical reset tool; the 1HBH's disguise weapon |
| [Closed Stance](closed-stance.md) | The specialist backhand footwork that extends sideways alignment |
| [Scapular Retraction](scapular-retraction.md) | The 1HBH's counterweight mechanism; key coaching diagnostic |
| [Tennis Elbow (Lateral Epicondylitis)](tennis-elbow-(lateral-epicondylitis).md) | The injury caused by arm-dominant backhand mechanics |
| [High-Ball Backhand](high-ball-backhand.md) | The defining technical challenge of the 2026 game |
| [Backhand Patterns of Play](backhand-patterns-of-play.md) | Cross-court control, down-the-line trigger, redirect pattern |
| [V-Shape Lock](v-shape-lock.md) | The 2HBH preparation mechanism that prevents a dragged takeback |
| [Lefty-Forehand Drill](lefty-forehand-drill.md) | The drill that rewires the non-dominant arm's driving role |
| [Hip Clearance](hip-clearance.md) | The rotation failure that jams the arm and kills racket-head speed |
...
For a right-handed player, the two-handed backhand is mechanically a **left-handed forehand** executed from a right-handed stance:
- The **left hand** drives the racket through the contact zone
- The **left shoulder** rotates forward
- The **left side of the core** unwinds
- The **right hand** maintains the grip, provides stability, and contributes to the final contact — but does not initiate or drive the stroke
...
**Hip Clearance Failure** — see [Hip Clearance](hip-clearance.md).
