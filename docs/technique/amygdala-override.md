...
See [Between-Point Ritual](../psychology/between-point-ritual.md) — the gating mechanism that creates a neurological buffer between the threat event and the next point.

### 6. The 15-Second Reset
See [15-Second Reset Protocol](../psychology/15-second-reset-protocol.md) — the complete temporal sequence for suppressing amygdala activity, restoring vagal tone, and retrieving motor policies from the basal ganglia.
