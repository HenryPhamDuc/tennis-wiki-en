...
> Intention leads the vital energy; vital energy leads the body.
...
From a cognitive science perspective, this is the description of a system in which [Motor Memory](motor-memory.md) and [Tacit Knowledge](tacit-knowledge.md) are fully operational, and [Intention-Led Movement](intention-led-movement.md) is the mode of engagement.
...
The body finds the appropriate configuration automatically, guided by the felt qualities of the incoming ball and the intention of the response. This is [Proprioception and Haptic Feedback](proprioception-and-haptic-feedback.md) in service of [Intention-Led Movement](intention-led-movement.md).
...
- Cultivating the conditions for [Flow State](../psychology/flow-state.md) rather than drilling explicit mechanics
- Trusting the nervous system's capacity for [self-calibration](../players/sensorimotor-calibration.md)
