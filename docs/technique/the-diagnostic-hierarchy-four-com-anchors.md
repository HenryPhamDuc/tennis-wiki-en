---
title: "The Diagnostic Hierarchy: Four CoM Anchors"
language: en
...
- Global co-contraction: the arm felt stiff rather than elastic
- Petit Bras mechanics: the shot was pushed rather than whipped
- Breathing was held or shallow rather than exhaled through the strike
...
See [Between-Point Reset Ritual](../psychology/between-point-reset-ritual.md) and [Sympathetic Nervous System Activation](sympathetic-nervous-system-activation.md).
...
**Signs of Vestibular failure**:
- Shanks and frame hits despite adequate preparation
- "Camera shake" on the contact — the ball felt unstable through the strings
- Late contact on balls that arrived at a predictable location
...
**Signs of Ground failure**:
- Shot lacked depth and pace despite swing effort
- The arm felt "heavy" or "alone" — generating all the power independently
- Recovery after the shot required extra steps because the CoM was already displaced forward or sideways
...
See [Centre of Gravity - The Master Variable](centre-of-gravity-the-master-variable.md) and [The Dantian - CoG as Command Centre](the-dantian-cog-as-command-centre.md).
...
**Structural checks**:
- Volley: Did the racket head stay above the wrist through contact? (L-Shape / Bone-on-Bone Protocol)
- Forehand: Did the elbow stay in the V-Lock position away from the ribcage?
- Serve: Did the elbow reach at or above shoulder height in the Trophy Position?
- Backhand (one-hander): Did the non-dominant arm drive backward at contact? (Counter-Balance)

**Correction**: a physical constraint drill chosen to make the correct structural position the only available solution. The constraint approach bypasses verbal instruction and reaches the subconscious movement system directly. See [The Degrees of Freedom Problem in Coaching](../biomechanics/the-degrees-of-freedom-problem-in-coaching.md).
