...
Transient Hypofrontality is the temporary suppression of the [Prefrontal Cortex](../tactics/prefrontal-cortex.md), allowing the heavily myelinated, subconscious networks of the [Basal Ganglia](basal-ganglia.md) and [Cerebellum](../biomechanics/cerebellum.md) to execute motor programs with zero cognitive friction. In tennis, it is both the neurological description of the [Mushin](../psychology/mushin.md) state and a trainable condition that can be deliberately engineered.
