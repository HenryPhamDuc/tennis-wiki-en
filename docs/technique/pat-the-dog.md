...
|---|---|---|
| Artificial Shaping | Trying to force the racquet into the position using arm muscles | The motion becomes robotic, destroying timing and [Lag Mechanics](lag-mechanics.md) |
