...
**Tennis benefits:** Studies show caffeine improves serve accuracy and agility specifically during the third set — the point at which cognitive fatigue begins significantly impairing performance. It is the cognitive dimension of the [Performance Cliff](../biomechanics/performance-cliff.md) that caffeine most directly addresses.
