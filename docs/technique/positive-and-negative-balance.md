---
title: "Positive and Negative Balance"
language: en
...
When the shoulder-to-foot vertical stack is achieved:
1. **GRF is directed upward through the spine** — ground reaction force transfers into the stroke rather than dissipating sideways
2. **Pectoral Compression** — the "chest engine" can compress against the stationary lower body base, creating a hydraulic press effect
3. **No arm compensation** — the player doesn't need to force the volley with the arm, because the structural alignment generates the power
