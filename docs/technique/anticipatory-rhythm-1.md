...
Understanding Anticipatory Rhythm is central to both exploiting it as a weapon (through [Height-Change Tactics](height-change-tactics.md)) and maintaining it under pressure (as part of [Anticipatory Mode](anticipatory-mode.md)).
...
The key is *irregularity*: alternating every other ball allows the opponent to establish a new anticipatory rhythm. Unpredictable deployment prevents rhythm re-establishment. See [Height-Change Tactics](height-change-tactics.md) for the full application.

---

## Maintaining Rhythm Under Pressure

When stress increases (tight score, important points), players are at risk of losing anticipatory rhythm and slipping into reactive processing. [Mushin State](mushin-state.md) training and structured between-point rituals (see the 20-Second Reset concept in the broader manual) support rhythm maintenance under competitive conditions.
