---
title: "Type IIb Fast-Twitch Optimisation"
language: en
...
**Protocol structure**:
- Execute full forehand or serve kinetic chain at **absolute maximum velocity**.
- Minimal rest between reps (15–20 giây) — enough for partial PC recharge.
- Low volume per set (4–6 reps) — Type IIb fatigue quickly; more reps = reduced velocity = wrong fibre recruited.
- High neural demand per rep: Each rep must be **maximum intent**, not moderate effort.
...
Example:
1. Heavy squat at 80% 1RM × 3 reps.
2. Immediately: Maximum velocity jump squats × 5 reps.
