...
Geometric Recovery is the discipline of returning to the tactically correct court position after every shot — specifically, the position dictated by the [Bisector Rule](bisector-rule.md) rather than by habit or by the physical center of the court. It is the positional foundation of all defensive and neutral baseline play.
