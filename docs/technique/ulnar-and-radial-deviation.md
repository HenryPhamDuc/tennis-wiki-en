---
title: "Ulnar and Radial Deviation"
language: en
...
**Structural function**: In ulnar deviation, the radius and ulna bones of the forearm align directly behind the impact zone, providing the skeletal buttress against the ball's momentum. This is the "cocked wrist" position fundamental to the [L-Shape Lock](l-shape-lock.md).

**Grip dependency**: Ulnar deviation is anatomically easiest in the [Continental Grip](continental-grip-anatomy.md). It is the path of least resistance. In an Eastern grip, the same position requires active muscular effort and is anatomically strained — making it difficult to hold under pressure. Continental makes the lock automatic; Eastern makes it effortful.
