...
1. **The "Pop-Up"**: Wrist extends upward, face opens uncontrollably.
2. **The "Sitter"**: Wrist collapses under heavy pace; the mechanical recoil absorbs energy rather than reflecting it, producing a weak, hittable ball.
...
L-Shape Integrity and [Grip Pressure](grip-pressure.md) work as a system:
...
L-Shape Integrity is one of two components of the [Double-Bend Structure](double-bend-structure.md):
- L-Shape manages the *wrist* (large force redirection, face stability)
- Micro-flexed elbow manages *vibration* (high-frequency chatter from spin)
