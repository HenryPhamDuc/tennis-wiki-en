...
Thalamic Automaticity is the deliberate use of rigid pre-point rituals to intentionally suppress the analytical brain — shutting down the [Prefrontal Cortex](../tactics/prefrontal-cortex.md) and handing motor control to the heavily myelinated, subconscious [Basal Ganglia](basal-ganglia.md) before execution begins. It is the primary practical tool for engineering [Mushin](../psychology/mushin.md) under competitive pressure.
...
By the time the player initiates their serve motion, the [C-to-I Transition](c-to-i-transition.md) has already been completed. The analytical brain is not present at execution time — it was handled during the ritual.
