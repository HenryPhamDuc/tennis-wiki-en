...
Where ω is the angular velocity of the ISR and r is the total lever length from shoulder to racket tip. This is the same radius-amplification principle as the [Straight-Arm Forehand](straight-arm-forehand.md) — but applied in the axial rather than sagittal plane.
...
Old Knowledge coaching cue: "Snap your wrist at contact."
New Knowledge understanding: the wrist should remain *stable*. Any voluntary wrist snap interrupts the ISR mechanism and produces less racket speed, not more.
...
- The maximum stretch of the ISR mechanism occurs at the bottom of the [Drop on Edge](drop-on-edge.md) — when the racket head has fallen to its lowest point and the shoulder internal rotators are maximally stretched
