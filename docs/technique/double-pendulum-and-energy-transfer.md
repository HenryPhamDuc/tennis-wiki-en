---
title: "Double Pendulum and Energy Transfer"
language: en
...
1. **Segment 1 (forearm)**: Decelerates after reaching peak angular velocity
2. **Segment 2 (racket)**: Accelerates as the forearm's momentum is transferred to it
...
Any attempt to consciously "force" the snap engages the antagonist muscles, triggering co-contraction — the classic [Petit Bras and Angular Momentum](petit-bras-and-angular-momentum.md) failure at the terminal node.
...
When [Internal Shoulder Rotation](internal-shoulder-rotation.md) reaches its maximum arc, the ISR decelerates. This deceleration transfers momentum to the forearm-racket system, causing the forearm to pronate violently and the racket head to snap through contact at speeds exceeding 120 mph.
