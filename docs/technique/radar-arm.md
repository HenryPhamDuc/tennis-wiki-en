...
The Radar Arm extended upward during overhead preparation also performs the same function as the [Tossing Arm as Rotational Regulator](../players/tossing-arm-as-rotational-regulator.md) in the serve: it creates the "Stretched Side" that generates shoulder tilt. When the tossing/non-dominant arm is up:
...
If the Radar Arm drops prematurely:
- Depth perception against the sky degrades; the player misjudges where to position for contact
- Shoulder tilt collapses (see [The Hanging Left Arm Fault](the-hanging-left-arm-fault.md))
- The Trophy Anchor cannot be maintained; the overhead loses its vertical axis
- The player is forced to "arm" the smash — hitting with only the shoulder and forearm rather than the full chain
