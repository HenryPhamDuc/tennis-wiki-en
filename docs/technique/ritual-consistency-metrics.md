---
title: "Ritual Consistency Metrics"
language: en
...
**Break point application**: On break points, the preceding rally is often the most intense of the game. A player who cannot achieve HRV recovery within 15 seconds arrives at the next point still physiologically activated — which compounds the [Amygdala Trigger and Neural Reversion](amygdala-trigger-and-neural-reversion.md) effect of the break-point score itself.
...
**What it measures**: Whether the player's implicit motor commitment — the subcortical locking of the motor engram before stroke execution — is being maintained under pressure. Any divergence between neutral-point and break-point Mu-Beta suppression timing identifies a [Neural Reversion](../psychology/neural-reversion.md) event. (See [Mu-Beta Suppression](../psychology/mu-beta-suppression.md) for the full framework.)
