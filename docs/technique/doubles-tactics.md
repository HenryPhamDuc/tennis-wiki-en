...
The primary objective of every doubles point is to **both players reaching the Attacking Zone** (inside the service line) before or immediately after the first shot exchange. Two players at the net create a "wall" — the _Shadow Principle_ from four rackets in the forward position mathematically eliminates most passing angles.
...
1. **Confusion and Hesitation**: A ball down the middle creates a split-second delay as partners decide who should take the shot. This **kinetic timing disruption** breaks the opponents' point construction rhythm
2. **Angle Elimination**: Exactly as in singles [Center Theory](percentage-tennis.md), a ball down the middle eliminates the opponent's ability to hit sharp-angled winners — they must hit back toward the centre of the net, directly into the strength of the net team's position
...
- **Psychological effect**: The returner cannot commit to a cross-court or down-the-line return without risking interception — a high-[neural pressure](neural-pressure.md) decision made in under 150ms
...
| [Percentage Tennis](percentage-tennis.md) adaptation | 70% cross-court | 70% center pipe + net transition |
