...
For volley preparation, the source material defines an elite standard of just 20–25° of shoulder rotation — sufficient to "arm" the volley while staying within the [Zero-Swing Threshold](zero-swing-threshold.md). The "Hand-in-a-Box" rule describes this: the hitting hand and racket should never leave the front of the ribcage. If the hand passes the line of the hitting-side shoulder, the player has entered the danger zone.
