...
The branch of the autonomic nervous system responsible for the "fight or flight" response — the physiological pathway the [Amygdala Hijack](amygdala-hijack.md) activates, producing the hormonal and muscular cascade that degrades tennis performance under pressure.
...
- Constricts the visual field (tunnel vision; [Quiet Eye](quiet-eye.md) duration collapses)
...
Each of these effects directly undermines tennis stroke mechanics. The result is [Petit Bras](petit-bras.md): the rigid, steering, low-velocity stroke that looks like the player suddenly forgot how to play.
...
| **Optimal ("Flow")** | Challenge matches skill | Full kinetic chain; elastic power; [Mushin](../psychology/mushin.md) accessible |
...
The [15-Second Reset Protocol](../psychology/15-second-reset-protocol.md) and [Between-Point Ritual](../psychology/between-point-ritual.md) both work primarily through this vagal pathway.
