...
### Jumping Power — MTP Là Final Link

Khi player thực hiện split-step hay explosive first step:
1. Hông, gối, và mắt cá extend (triple extension).
2. Chân push vào mặt sân.
3. **Final contact với sân là tại MTP joint** (bàn ngón chân).
4. MTP flexors là cơ bắp cuối cùng push vào sân trước khi foot leaves ground.

Nếu MTP flexors yếu:
- Final push yếu → overall jump height/speed giảm.
- Force leaks ở final link → kinetic chain incomplete từ ground lên.
- Analogy: Như có engine mạnh (hips, quads) nhưng transmission yếu (MTP) → power không fully delivered.
...
MTP flexor work belongs trong **pre-hab protocol** (25 phút trước mỗi session):
- 2–3 sets towel scrunch hoặc resistance band flexion.
- Activates foot musculature before on-court demands.
- Takes 3–4 phút — minimal time investment, significant return.
...
[Gravity Step](gravity-step.md) — where forward momentum is used to initiate split-step loading — requires that the foot **actively pushes into the ground** at the point of contact. This push is partly MTP flexor driven. Strong MTP flexors → more effective gravity step execution → more elastic energy stored in split-step SSC.
