...
### Movement
- **Wide lateral stops** ([Out-Wide Brake](../fitness/out-wide-brake.md)): The outside quad and glute must eccentrically absorb 100% of lateral kinetic energy before immediately redirecting it as a Power Step.
- **[Sliding](../biomechanics/sliding.md)**: Clay sliding distributes lateral momentum gradually, reducing the eccentric demand per joint. Hard court "sticking" compresses this into a single joint-loading moment, massively increasing the eccentric requirement.
- **[Triple Flexion](triple-flexion.md) landings**: On serve landings and approach-run stops, 2.0–3.0x bodyweight forces must be absorbed eccentrically by the quads and glutes.

### Post-Contact Braking
- **Forehand finish**: At modern racket-head speeds (130+ km/h), the rotational momentum of the [Kinetic Chain](../biomechanics/kinetic-chain.md) must be absorbed after the ball leaves the strings. The arm cannot simply stop — the energy must be redirected. Failure to do so eccentrically causes the shoulder to absorb it.
- **[Core as Shock Absorber](core-as-shock-absorber.md)**: The core must eccentrically decelerate rotational momentum after contact. If it cannot, the residual force is absorbed by spinal ligaments and facet joints (see [Braking Failure](../biomechanics/braking-failure.md)).
...
| Box jump landings (absorb, hold) | [Triple Flexion](triple-flexion.md) eccentric load |
| Slide-and-brake on clay | [Out-Wide Brake](../fitness/out-wide-brake.md) specificity |
