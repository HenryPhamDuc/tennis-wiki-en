...
This is the biological basis for the transition from [Self 2](../psychology/self-1-vs-self-2.md)'s "learning" phase (deliberate, slow, conscious) to its "automated" phase (fast, implicit, pressure-resistant).
