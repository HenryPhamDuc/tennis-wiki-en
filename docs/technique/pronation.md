...
**Pronation** is the outward rotation of the forearm around its long axis — the corkscrew motion that flips the racket face 90° from edge-leading to strings-flat in the final 80 milliseconds before ball contact. On the serve, it immediately follows [Internal Shoulder Rotation](internal-shoulder-rotation.md) and collectively with ISR generates approximately 40–50% of total ball velocity.
...
1. **[Internal Shoulder Rotation](internal-shoulder-rotation.md)** initiates — the upper arm begins rotating inward at 1,500–3,000°/s
