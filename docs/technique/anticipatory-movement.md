...
Anticipatory Movement is the initiation of footwork or body positioning *before* the ball arrives, triggered by reading the opponent's preparation rather than responding to ball flight. It is the physical motor output of [Anticipatory Mode](anticipatory-mode.md) in its most direct form.
...
- **On the split-step**: [Directional Pre-Load](directional-pre-load.md) toward the read direction before landing
...
**Premature commitment**: Moving too early, before cue-reading confirms the direction, results in wrong-footing. The solution is refining [Cue Reading](cue-reading.md) accuracy rather than reverting to waiting.
