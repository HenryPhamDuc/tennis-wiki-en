...
The most common error is carrying the groundstroke backswing mentality to the net — the [Spatial Gating](spatial-gating.md) problem — producing volleys with extended backswings that exceed the available execution window against a well-struck pass.
