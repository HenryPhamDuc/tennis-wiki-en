...
The return of serve represents the most extreme temporal constraint in tennis performance: facing a ball delivered at 180–220 km/h, the returner has approximately 0.8 seconds from racket-to-racket. It is the paradigm case for [Predictive Processing](predictive-processing.md) and embodied anticipation in sport.
...
This is [Sensorimotor Calibration](../players/sensorimotor-calibration.md) applied to one of the most extreme motor problems in sport.
