---
title: "Petit Bras Under Pressure"
language: en
...
Under the [Amygdala Trigger and Neural Reversion](amygdala-trigger-and-neural-reversion.md) cascade:

1. The brain distrusts the automated subcortical loop and returns control to the prefrontal cortex
2. The conscious mind feels an urgent need to "control" the ball
3. The hand and wrist fire first — the closest, most immediately controllable segments
4. The shoulder fires in isolation via shoulder flexion and elbow extension
5. The arm is completely disconnected from the legs and core power engine
6. The result: a pushed, steered shot with minimal elastic energy
...
This total implicit commitment is precisely what prevents the Petit Bras reflex from manifesting during critical break points. There is no window in which the PFC can intervene and reverse the kinetic chain sequence. (See [Mu-Beta Suppression](../psychology/mu-beta-suppression.md).)
