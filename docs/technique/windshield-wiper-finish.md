...
The "snap" of the wiper is the terminal expression of the [Kinetic Chain](../biomechanics/kinetic-chain.md) — the final acceleration event after the hips, torso, and arm have sequentially unloaded.
