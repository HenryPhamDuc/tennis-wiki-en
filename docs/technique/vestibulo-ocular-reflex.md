...
3. Trunk can rotate at full [Angular Momentum](angular-momentum.md) capacity → [Internal Shoulder Rotation](internal-shoulder-rotation.md) fires at full speed
