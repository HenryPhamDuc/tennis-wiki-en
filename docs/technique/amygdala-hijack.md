...
| **Physical Result** | [Petit Bras](petit-bras.md) — grip tightens, wrist stiffens, kinetic chain breaks |
...
The hijack is not limited to scoreboard pressure. Triggers include:
- A fast incoming ball (95 MPH from short range at the net)
- An easy put-away opportunity the player cannot afford to miss
- Glare or visual noise from sun conditions
- An opponent's deceptive shot creating a prediction error
- Gamesmanship disrupting the player's rhythm
...
- [Amygdala Override](amygdala-override.md) — the overarching countermeasure system
- [Between-Point Ritual](../psychology/between-point-ritual.md) — gating mechanisms that suppress the amygdala before the next point
- [Mushin](../psychology/mushin.md) — the neurological goal state in which the hijack is absent
- [Quiet Eye](quiet-eye.md) — the visual anchor that creates a buffer against hijack
- [15-Second Reset Protocol](../psychology/15-second-reset-protocol.md) — the structured temporal intervention
- [Petit Bras](petit-bras.md) — the physical expression the hijack produces
...
|---|---|
| [Petit Bras](petit-bras.md) | The physical stroke failure the hijack produces |
| [Amygdala Override](amygdala-override.md) | The trained countermeasure system |
| [Mushin](../psychology/mushin.md) | The neurological goal state — hijack absent |
| [Between-Point Ritual](../psychology/between-point-ritual.md) | Gating mechanism to prevent hijack onset |
| [Quiet Eye](quiet-eye.md) | Visual anchor that buffers against hijack |
| [15-Second Reset Protocol](../psychology/15-second-reset-protocol.md) | Structured point-by-point suppression protocol |
| [Prefrontal Cortex Reversion](prefrontal-cortex-reversion.md) | The neural mechanism the hijack triggers |
| [Basal Ganglia](basal-ganglia.md) | The automated system the hijack displaces |
| [Mental Toughness](../psychology/mental-toughness.md) | The broader psychological framework hijack resistance belongs to |
| [Sympathetic Nervous System](sympathetic-nervous-system.md) | The physiological pathway the hijack activates |
