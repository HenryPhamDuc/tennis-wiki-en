---
title: "One-Handed Backhand Counter-Balance"
language: en
...
When the torso opens to the net during the swing:
- The racket drags *across* the ball instead of driving *through* it
- Linear force is converted into rotational scatter
- The ball sprays wide or produces a weak, "slappy" contact
- The player loses access to the full length of the lever arm
...
This counter-directional movement creates:
1. **A physical lock on the shoulders**: the chest is prevented from rotating toward the net; it stays facing the side fence through and past contact
2. **A long-lever whip**: because the torso is locked sideways, 100% of kinetic energy is directed linearly through the contact point rather than dissipating into rotational scatter
3. **Equal and opposite force**: the non-dominant arm's backward drive creates the mechanical equal-and-opposite force that amplifies the hitting arm's forward momentum
