...
3. **Internal shoulder rotation:** The dominant shoulder rotates inward aggressively, snapping the racket face downward — the same motion as the serve's final acceleration phase in the [Kinetic Chain](../biomechanics/kinetic-chain.md)
...
| **Mechanics** | Serve-like snap | Soft-hand cushion, deep [Triple Flexion](triple-flexion.md) |
...
The 2026 overhead is a power-first, low-clearance weapon — using the same vertical explosion as the [Vertical GRF](vertical-grf.md) in the serve to generate maximum downward force.
