...
**Split:** The split-step resets readiness after any wide movement. Before beginning recovery toward the tactical centre, the player performs a split-step that:
- Stops the lateral momentum of the previous sprint
- Resets the body's elastic pre-loading for the next directional push
- Recalibrates visual focus from the shot just played to the opponent's preparation for the next one
