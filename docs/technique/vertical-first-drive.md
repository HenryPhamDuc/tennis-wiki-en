...
1. Triple Joint Extension fires (ankle → knee → hip): the body drives straight upward
2. Contact point elevation is maximized before rotation begins
3. Lower-body rotation follows and compounds the upward momentum
4. The torso's uncoiling (X-Factor release) then fires through the already-elevated body position
...
**Contact point height = downward trajectory angle**. The higher the contact point, the steeper the angle into the service box. A steeper trajectory:
- Clears the net with greater margin
- Lands deeper in the service box on a sharper downward arc
- Requires the returner to deal with a ball arriving at a more punishing angle
