...
|---|---|---|
| **[Disconnect](disconnect.md)** | Hips and shoulders rotate as a single unit | X-Factor = 0; player reduced to arm-and-upper-body hitting; power halved |
...
| **[Right-Hand Dominance](right-hand-dominance.md)** (two-handed backhand) | Right hand drives the stroke instead of the left | Pushing action; weak, flat, "slappy" ball with no weight; sits up for opponent |
