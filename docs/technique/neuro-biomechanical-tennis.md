---
title: "Neuro-Biomechanical Tennis"
language: en
...
1. **Biomechanical foundations** — how the body generates, transfers, and dissipates force through the [Kinetic Chain](../biomechanics/kinetic-chain.md)
2. **Neurological governance** — how the brain, [Visual Processing](visual-processing.md), [Proprioception](../biomechanics/proprioception.md), and the _Nervous System_ govern movement selection and execution
3. **The Inner Game** — how [Self 1 vs Self 2](../psychology/self-1-vs-self-2.md) and the [Mental Game](../psychology/mental-game.md) determine whether physical capacity reaches the ball
