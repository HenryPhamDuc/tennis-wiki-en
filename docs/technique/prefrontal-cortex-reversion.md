---
title: "Prefrontal Cortex Reversion"
language: en
...
The neural mechanism by which the [Amygdala Hijack](amygdala-hijack.md) transfers motor control away from the automated, high-speed [Basal Ganglia](basal-ganglia.md) loops back to the slow, conscious prefrontal cortex (PFC) — the region used by beginners to consciously think through movement.
...
5. [Petit Bras](petit-bras.md) is the physical result
...
| Activated by | Training, [Mushin](../psychology/mushin.md), calm | [Amygdala Hijack](amygdala-hijack.md), stress |
...
The return to implicit control requires:
1. Amygdala down-regulation (via [15-Second Reset Protocol](../psychology/15-second-reset-protocol.md) or [Between-Point Ritual](../psychology/between-point-ritual.md))
2. Restoration of parasympathetic tone (vagal stimulation)
3. Retrieval of motor policies from the basal ganglia (blueprint visualization)

Only when the prefrontal cortex stops "protecting" the outcome does the basal ganglia regain motor authority — and [Mushin](../psychology/mushin.md) become accessible.
