...
As the match progresses and [Cognitive Fatigue](cognitive-fatigue.md) accumulates, the between-point ritual's residue-clearance efficiency decreases. The emotional cortisol tail takes longer to clear. The forward-looking visualisation is harder to sustain. The trigger cue produces less reliable transition to execution mode.

This creates a compounding cycle:
1. Early-match residue clears efficiently; each point starts clean
2. Mid-match cognitive fatigue reduces ritual efficiency; residue takes longer to clear
3. Late-match: ritual efficiency is severely reduced; each point begins with partial residue from the previous one
4. The player's performance degrades not because they are "mentally weak" but because the cognitive clearance mechanism is fatigued
