...
This is why the transition from baseline to net requires a complete biomechanical recalibration — from centrifugal force generation toward linear momentum transfer, geometric stabilisation, and ultra-fast visual processing. See [Baseline-to-Net Transition](baseline-to-net-transition.md) and [Net Play](net-play.md).
...
| Category | Concepts |
|---|---|
| **Positioning** | [Baseline](baseline.md), [Return Positioning](return-positioning.md), [Bisector Rule](bisector-rule.md), [Geometric Recovery](geometric-recovery.md) |
| **Baseline Tactics** | [Cross-Court Rally Control](cross-court-rally-control.md), [Neutralisation Mindset](neutralisation-mindset.md), [75% Rule](75%-rule.md), [Second Serve Aggression](second-serve-aggression.md) |
| **Net Entry** | [Baseline-to-Net Transition](baseline-to-net-transition.md), [Approach Shot](approach-shot.md), [Sneak Attack](sneak-attack.md), [Heavy Approach](heavy-approach.md), [Transition Zone](transition-zone.md) |
| **Return of Serve** | [Return Positioning](return-positioning.md), [Second Serve Aggression](second-serve-aggression.md), [Cross-Court Heavy Return](cross-court-heavy-return.md), [Return-and-Volley](return-and-volley.md) |
| **Groundstroke Patterns** | [Cross-Court Rally Control](cross-court-rally-control.md), [Neutralisation Mindset](neutralisation-mindset.md), [Moonball Reset](moonball-reset.md) |
| **Mechanics** | [Stance at the Baseline](../players/stance-at-the-baseline.md), _Horizontal GRF_, [X-Factor Stretch](x-factor-stretch.md) |
| **Training** | [Fence Drill](fence-drill.md), [Return Box Drill](return-box-drill.md), [Game of 7](game-of-7.md) |
...
- [Stance at the Baseline](../players/stance-at-the-baseline.md)
