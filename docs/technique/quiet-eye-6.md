...
It is the visual-domain complement to the [Bounce-Hit Technique](../psychology/bounce-hit-technique.md)'s auditory-domain approach.
...
While the [Predictive Saccades](predictive-saccades.md) article (Alcaraz vault) describes the elite returning model — eyes jumping *ahead* to the anticipated intercept point — Quiet Eye describes a complementary process: the *quality* of the gaze once it has arrived at the contact zone.
...
The [Bounce-Hit Technique](../psychology/bounce-hit-technique.md) occupies Self 1 through the auditory-temporal channel. Quiet Eye occupies Self 1 through the visual-perceptual channel. Players who find one technique more accessible than the other can use it alone; players who use both simultaneously achieve the most complete Self 1 suppression available.
