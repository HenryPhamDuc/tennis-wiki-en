---
title: "Tactical Displacement Formations"
language: en
...
# Tactical Displacement Formations
...
**Execution**: Before the serve, the net player signals with a hand behind their back:
- Open palm → net player holds their side (no movement)
- Clenched fist → net player poaches to the designated side
