...
- **Arousal → Explosive Readiness:** The arousal sharpens reflexes, heightens alertness, and channels into the aggressive [Aggressive Return Positioning](aggressive-return-positioning.md), decisive [Split-Step](split-step.md) timing, and committed [Blitz-Chess Model](../tactics/blitz-chess-model.md) execution that defines elite returning
...
- **Closed-off posture:** Shoulders rounding, chest closing, racket held tight — tension everywhere that prevents [Elastic Energy](elastic-energy.md) loading
