---
title: "The Lasso Finish vs Across-the-Chest Follow-Through"
language: en
...
# The Lasso Finish vs Across-the-Chest Follow-Through
...
The key condition: the grip tension must remain at 2–3/10 through contact and release *before* the Lasso arc begins. Any attempt to steer the follow-through using muscular force kills the elastic recoil. The Lasso cannot be manufactured; it can only be *permitted*. See [The Fascial Network and Proprioception](the-fascial-network-and-proprioception.md).
...
**The Lasso vs Across Test**: an across-the-chest finish at modern topspin rates indicates one of two things:
1. Insufficient swing speed — the fascial spring did not reach maximum pre-stretch, so there is no elastic recoil to produce the Lasso
2. A habituated finish from an earlier technical phase — the nervous system has a conditioned across-the-chest pattern that overrides the natural recoil
...
**The "Halo" Cue**: imagining the racket must draw a halo around the head after contact — the circular deceleration path that protects the shoulder. This occupies Self 1 with a non-analytical spatial task while allowing Self 2 to execute the natural fascial recoil. See [Self 1 and Self 2](../psychology/self-1-and-self-2.md).
