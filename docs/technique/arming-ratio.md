...
The Arming Ratio is the diagnostic test for detecting [Arming](arming.md) in real time: **does the racket head accelerate before the hips have cleared?**

Specifically — does the hand pass the plane of the back hip before the navel faces the net?

If yes: the [Stretch-Shortening Cycle](stretch-shortening-cycle.md) has failed and the player is pulling with the shoulder rather than whipping from the core. This is the first fault to identify and correct.
...
> **Does the racket head accelerate before the hips have cleared?**
> If the hand passes the plane of the back hip before the navel faces the net → the SSC has failed → [Arming](arming.md) is occurring.

This test can be applied by a coach watching live or from video at any frame rate that captures the hip clearance moment. It is the first check in the [Technical Diagnostic Matrix](technical-diagnostic-matrix.md) (Chapter 6, section 6.10) before any other technical cue is introduced.

## What It Detects

The Arming Ratio catches the precise moment the [Kinetic Chain](../biomechanics/kinetic-chain.md) sequence breaks down. In correct sequencing:

1. Legs drive → hips uncoil → navel turns to the net
2. *After* the navel faces the net → torso accelerates
3. *After* torso decelerates → shoulder transfers to the arm
4. *After* shoulder decelerates → wrist/racket fires
