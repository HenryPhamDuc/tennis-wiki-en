...
It is the most delicate expression of the [Absorb](absorb.md) principle at the net, and the entry point for understanding the full [Grip Pressure](grip-pressure.md) spectrum.
...
- **Wrist and Elbow**: The [L-Shape Integrity](l-shape-integrity.md) and [Double-Bend Structure](double-bend-structure.md) are maintained even at 2/10 grip. The structure is what directs the ball; the softness is what kills its pace.
...
Maintaining [L-Shape Integrity](l-shape-integrity.md) throughout is critical to disguise: the moment the wrist softens visibly, the shot is telegraphed.

---

## Relationship to Drop Volley

The Touch Volley and [Drop Volley](drop-volley.md) exist on a continuum:
