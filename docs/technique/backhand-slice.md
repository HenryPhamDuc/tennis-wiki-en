...
It is the [One-Handed Backhand (1HBH)](one-handed-backhand-(1hbh).md)'s defining tactical advantage: the same grip and preparation can produce both a drive and an attacking slice, creating disguise the [Two-Handed Backhand (2HBH)](two-handed-backhand-(2hbh).md) cannot replicate.
...
**Telegraphed Preparation**: decelerating the backswing visibly early reveals the drop shot or slice to the opponent. The correction is the shadow disguise drill (see [Backhand Patterns of Play](backhand-patterns-of-play.md)).
