...
- The muscles lengthen while producing force — the same quality required for [pre-hab](pre-habilitation.md) and deceleration work
...
The brief moment between the backswing and the forward swing. For maximum power, this phase must be **instantaneous** — in elite ATP/WTA players it is measured in single-digit milliseconds.
...
**The quantified cost of a long amortisation:** A pause of just **0.15 seconds** at the peak of the backswing produces a **10–20% loss in Internal Shoulder Rotation speed**. Because ISR contributes 40–50% of total ball velocity, even a modest amortisation leak produces a significant drop in ball speed — without any change in apparent swing effort.

The amortisation phase is also the critical vulnerability for [Self 1 intrusion](../psychology/self-1-vs-self-2.md): when anxiety causes a player to "check" their backswing or steer the shot, the brief hesitation is often precisely this phase extending. The swing looks normal from the outside; the power loss is invisible until the ball arrives soft.
