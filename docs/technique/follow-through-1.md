...
|---|---|
| High above dominant shoulder ([Buggy Whip - Lasso Finish](buggy-whip-lasso-finish.md)) | High [Angular Momentum](angular-momentum.md), extreme [Topspin](../players/topspin.md), [Open Stance](../players/open-stance.md) |
...
**High finish (lasso / buggy whip family)**
- [Nadal](rafael-nadal-—-forehand-profile.md): classic lasso, racket circles overhead
- [Alcaraz](carlos-alcaraz-—-forehand-profile.md): lasso on defensive balls; wiper on standard pace balls
- Tsitsipas: high wiper exit, dominant-side high finish

**Windshield wiper / compact family**
- [Djokovic](novak-djokovic-—-forehand-profile.md): finishes around the side, more compact, not overhead
- [Medvedev](../players/medvedev-—-forehand-profile.md): linear follow-through, minimal wrist break, late arm extension

[Federer](../players/roger-federer-—-forehand-profile.md)'s classical follow-through (over the non-dominant shoulder, relaxed wrist, long swing lines) represents the prior era's reference model.
...
The follow-through is the most visible indicator of the eras described in [Swing Path and Follow-Through Eras](swing-path-and-follow-through-eras.md):
