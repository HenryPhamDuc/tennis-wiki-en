...
Initiative Stealing creates a fundamental neurological asymmetry:
- **Alcaraz:** Operating from implicit systems (pre-programmed [Implicit Decision Trees](implicit-decision-trees.md)); no decision latency
- **Opponent:** Forced into PFC-led reactive processing, continuously adapting to unexpected shots
