...
It creates maximum space between the body and the racket head, enabling the deep [Gravity Drop](gravity-drop.md) and down-then-up trajectory that produce his signature topspin output.
...
The physics: by increasing the radius (r) of the preparation phase, Alcaraz increases the potential energy stored in the preparation position before the gravitational drop begins.
