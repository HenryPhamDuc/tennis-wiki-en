...
Pre-Stiffening is the feed-forward neural signal sent by the cerebellum to the ankle and knee stabilizers **before** ground contact, setting the joints to the correct stiffness level for the incoming impact so that 100% of [Ground Reaction Force (GRF)](ground-reaction-force-(grf).md) is transmitted through the [Kinetic Chain](../biomechanics/kinetic-chain.md) rather than absorbed as soft-tissue deformation.

It is the mechanism that makes [Leg Stiffness](leg-stiffness.md) possible at the moment it is needed — because reactive stiffening after contact is too slow.
