...
The split-step is a deliberate GRF event. By landing with controlled force at the moment of the opponent's contact, the player:
1. Generates a vertical GRF spike (2.0–2.5× body weight)
2. Loads the Achilles and patellar tendons as [Biological Springs](biological-springs.md)
3. Uses the elastic rebound to power the first explosive lateral step
