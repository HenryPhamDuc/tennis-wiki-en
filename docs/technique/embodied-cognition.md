...
1. **Sensorimotor coupling** — perception and movement are continuously linked; you don't perceive and then move, you perceive *in order to* move
2. **Action-oriented perception** — the world is perceived in terms of what actions it affords, not as a neutral snapshot
3. **Real-time environmental interaction** — cognition is temporally grounded; it happens in the unfolding moment, not in offline deliberation
...
- Tools ([racket incorporation](body-schema-and-tool-embodiment.md)) and environment ([court, opponent](../system/extended-mind-theory.md)) both participate in cognition
...
When players treat cognition as purely internal — consciously analyzing technique mid-rally — performance degrades. This is the mechanism behind [Paralysis by Analysis](paralysis-by-analysis.md): conscious deliberation interrupts the sensorimotor loop that embodied skill depends on.
...
- Repetitive, context-rich practice that builds [Sensorimotor Calibration](../players/sensorimotor-calibration.md)
- Environments that provide varied affordances ([Ecological Dynamics](ecological-dynamics.md))
- Attention directed to targets and intentions rather than body mechanics ([Intention-Led Movement](intention-led-movement.md))

## Related Concepts

- [Tennis as Embodied Cognition](../system/tennis-as-embodied-cognition.md)
- [Body Schema and Tool Embodiment](body-schema-and-tool-embodiment.md)
- [Sensorimotor Calibration](../players/sensorimotor-calibration.md)
