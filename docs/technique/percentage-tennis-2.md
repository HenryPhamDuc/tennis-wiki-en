...
**Pressure management:** Aiming for the lines tells Self 1 that precision is required — which activates Self 1's analytical override and increases muscular tension ([Petit Bras](petit-bras.md) risk). Aiming for a large target area allows Self 2 to swing with fluid freedom. The less precision Self 1 believes is required, the more it stays out of the way.
...
Pre-decided process goals ("hit crosscourt to the backhand side") free Self 2 to execute without in-point deliberation — the same principle as [Implicit Decision Trees](implicit-decision-trees.md), applied at a strategic level rather than a shot-level.
