...
[Sensorimotor Calibration](../players/sensorimotor-calibration.md) is the process by which prediction error is progressively reduced. Each repetition updates the brain's internal predictive models. Expertise is accumulated calibration — not stored rules, but refined predictions.
