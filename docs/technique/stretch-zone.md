...
Learning occurs in three zones:
1. **Comfort Zone:** Tasks are too easy; no adaptation occurs (e.g., casual rallying).
2. **Stretch Zone:** Tasks are slightly beyond current capabilities, resulting in a 60–80% success rate. The brain is stressed enough to recognize errors and upgrade neural pathways.
3. **Panic Zone:** Tasks are too fast or complex. The nervous system reverts to old, ingrained habits (survival mode).
...
| Match Chaos | Playing points before mechanics are ingrained | Entering the Panic Zone; reinforcing old flaws like [Zombie Arm](zombie-arm.md) |
