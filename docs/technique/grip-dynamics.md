...
**Tight grip effects**:
- Reduces racket head speed (prevents the slingshot "lag" effect)
- Suppresses [Proprioception](../biomechanics/proprioception.md) and feel (the body senses touch best when muscles are loose)
- Introduces co-contraction: the forearm "fighting" itself, losing the [Neural Bracing](neural-bracing.md) precision
...
For volleys, slice, serves, and overheads, the Continental grip is the default because it:
- Requires no grip change between forehand and backhand volleys
- Allows natural face-opening for slice and touch shots
- Positions the wrist for maximum pronation in the serve
- Enables the "hammer" action (grip is oriented like holding a hammer)
