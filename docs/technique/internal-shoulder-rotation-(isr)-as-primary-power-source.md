---
title: "Internal Shoulder Rotation (ISR) as Primary Power Source"
language: en
...
Reid et al. (2013):
- **Internal shoulder rotation**: ~35% of impact speed
- **Horizontal arm flexion**: ~25%
- **Elbow/forearm**: relatively little
...
**The Stable L-Position**: The wrist must be in approximately 30° of extension and slightly ulnar-deviated at impact to channel ISR power efficiently. See [The Stable L-Position and Wrist Biomechanics](the-stable-l-position-and-wrist-biomechanics.md).

**Straight-Arm vs Double-Bend**:
- Straight-arm maximises *radius* (r) in v_t = ωr — more tangential velocity at the same rotational speed
- Double-bend reduces moment of inertia, allowing *higher ω* (angular velocity) of the shoulder — exploiting ISR more directly
Both arrive at high racket-head speed through different expressions of ISR
...
2. The weight of the racket, coupled with gravity, forces the shoulder into **external rotation** ("Tapping the Dog" — see [The Tapping the Dog Mechanism](../biomechanics/the-tapping-the-dog-mechanism.md))
...
The CNS actively manages ISR speed based on its assessment of structural safety. When the rotator cuff is fatigued, injured, or neurologically inhibited (by chronic chain compensation — see [Ground Reaction Force (GRF)](ground-reaction-force-(grf).md)), the CNS applies a protective brake, reducing ISR speed even when the player consciously attempts to swing harder.
