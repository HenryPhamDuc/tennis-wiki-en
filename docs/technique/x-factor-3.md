...
**The formula is simple**: the greater the shoulder-hip separation at the peak of the [Backswing](backswing.md), the greater the torque, and the greater the potential racket velocity on the forward swing.
...
**Player examples:**
- **Alcaraz**: extremely early preparation (backswing begins before the bounce), generating exceptional shoulder-hip separation through timing, not size of loop
- **Wawrinka/Thiem**: large X-Factor with aggressive loading beyond 45°; produces violent topspin pace
- **Federer**: relatively smaller X-Factor (chest stays highly sideways at contact) — compensated by elite timing and contact consistency
