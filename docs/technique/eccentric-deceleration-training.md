---
title: "Eccentric Deceleration Training"
language: en
...
Khi player pushes off hard cho lateral sprint → plant foot absorbs extreme lateral force:
- Nếu eccentric capacity thấp → ankle, knee, hoặc hip absorb force qua passive joint structures thay vì muscle.
- Kết quả: ACL stress, ankle sprain, hip labrum damage.
...
Labral tears trong tennis không thường xảy ra từ một incident — chúng accumulate từ **repeated eccentric loading mà braking system không đủ mạnh để absorb**. Pre-hab 25 phút trước mỗi session (xem [Coaching Conditioning](coaching-conditioning.md)) là directly targeting eccentric deceleration capacity.
...
Sử dụng resistance qua range of motion, focus trên **slow controlled lowering**:
- **Eccentric squat**: 3–4 giây lowering phase, control every millimetre.
- **Nordic hamstring curls**: Among the most research-supported eccentric exercises cho hamstring injury prevention.
- **Lateral lunge with eccentric hold**: Deep lateral lunge — hold deepest position 2–3 giây before returning.
...
### Isometric End-Range Holds (Xem [Isometric & Tendon Loading](../fitness/isometric-&-tendon-loading.md))
Holding **deepest phase of deceleration** position for 30–45 giây:
- Reorganizes collagen fibers along stress lines.
- Builds tendon stiffness that protects joints during braking.
...
- [Isometric & Tendon Loading](../fitness/isometric-&-tendon-loading.md)
...
- [Fascial Elasticity vs Hypertrophy](../fitness/fascial-elasticity-vs-hypertrophy.md)
