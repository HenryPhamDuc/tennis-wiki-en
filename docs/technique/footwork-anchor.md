...
1. The outside leg loads eccentrically like a compressed spring
2. The hip coil reaches peak tension over the anchored foot
3. The explosive unwind releases the stored energy through hip rotation
...
The power step at the net plants the lead foot to lock the hips and create the stable platform for the Still-Wall. For a right-handed player:
- Left foot leads on a forehand volley
- Right foot leads on a backhand volley
