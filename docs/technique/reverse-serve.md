...
The Reverse Serve is grouped alongside [Ambitennis](ambitennis.md)/[Overlapping Dual Forehand](overlapping-dual-forehand.md) and the [Volleyball Serve](volleyball-serve.md) as strokes the source predicts may follow the same adoption arc as previous [Tennis Stroke Evolution](tennis-stroke-evolution.md) innovations.
