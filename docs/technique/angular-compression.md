...
The term is borrowed from the broader [Angular Momentum](angular-momentum.md) framework. The ball's passing angles represent angular trajectories from the opponent's racket. By closing court (reducing the distance and therefore the physical angle available), the net player intercepts more of these trajectories within their reach. The word "angular" is not metaphorical — it refers to the literal geometric angles of the court.
