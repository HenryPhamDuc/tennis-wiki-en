...
**Strengths**: balanced power and spin, easy net transitions, stability on high balls.
**Weaknesses**: less natural topspin on very high bounces; may struggle on extremely low balls compared to more extreme grips.
...
**Strengths**: extreme spin on high balls, handles high-bouncing kick serves better.
**Weaknesses**: sacrifices flat power; low balls become difficult; requires significant arm/shoulder strength; more adjustment at the net.
...
The Continental is the universal grip for volleys — see [Two-Handed Backhand (2HBH)](two-handed-backhand-(2hbh).md) section on net play.

---

## Two-Handed Backhand Grip Configuration

The [Two-Handed Backhand (2HBH)](two-handed-backhand-(2hbh).md) uses a two-grip system:
...
**Eastern backhand grip** reduces elbow stress on the 1HBH by allowing a slightly more open racquet face, stabilizing the wrist and reducing extreme flexion angles at contact. This is a documented prevention strategy for [Tennis Elbow (Lateral Epicondylitis)](tennis-elbow-(lateral-epicondylitis).md).
...
At the net, the pace of incoming balls and the speed of positional changes make grip changes impossible. The [Two-Handed Backhand (2HBH)](two-handed-backhand-(2hbh).md) context requires a player at net to hold the Continental Grip because it:
