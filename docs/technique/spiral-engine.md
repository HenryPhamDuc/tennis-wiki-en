...
Elite tennis strokes are three-dimensional. As a player pushes against the ground, the force travels upward and rotates around the [Dantian & Spinal Axis](dantian-&-spinal-axis.md). The body uncoils from the ground up—ankles, knees, hips, and shoulders—creating a corkscrew effect. This spiral motion naturally produces the low-to-high racquet path required for topspin, integrating vertical lift with rotational torque.
