...
A standard session might involve hitting 10 forehands while focusing *only* on the [Split Step](split-step.md) timing, recording the set, reviewing the footage, and repeating. The goal is not to win the rally, but to execute the specific micro-goal correctly.
