...
The vestibular system (located in the inner ear) continuously processes:
- Head position relative to gravity
- Angular acceleration of the head (how fast and in what direction the head is rotating)
- Changes in [Center of Gravity](center-of-gravity.md) that could indicate a fall
...
The player experiences this as:
- The swing "not firing" despite effort
- Loss of racket-head speed on what felt like a clean hit
- Strokes that feel "blocked" under pressure (when anxiety also raises vestibular sensitivity)
