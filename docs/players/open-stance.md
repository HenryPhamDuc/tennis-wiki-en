...
In the source's era taxonomy, open stance is a marker of the 2020–2026 **Martial-Agentic** style, in contrast to the neutral and semi-open stances more typical of the 2000–2010 classical-modern era. See [Swing Path and Follow-Through Eras](../technique/swing-path-and-follow-through-eras.md).
...
| **Open / extreme open** | Rotational | Lateral (no forward step) | [Angular Momentum](../technique/angular-momentum.md) |

In an open stance forehand, forward weight transfer is minimal or absent. The power source is entirely rotational: hip rotation drives shoulder rotation, which drives arm and racket-head speed. This generates [Angular Momentum](../technique/angular-momentum.md) rather than linear momentum, producing heavy [Topspin](topspin.md) rather than flat penetrating pace.

## Why Open Stance Enables the Lasso

The [buggy whip / lasso finish](../technique/buggy-whip-lasso-finish.md) is mechanically natural from an open stance because:
...
The source's 2020–2026 taxonomy includes **"Air-born"** as a contemporary extreme: players like [Alcaraz](../technique/carlos-alcaraz-—-forehand-profile.md) use an explosive leg push that creates an almost vertical leap at contact — generating both rotational and upward force simultaneously. This is the open stance taken to its maximum expression.
