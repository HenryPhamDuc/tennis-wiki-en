...
From [Moment of Inertia](../technique/moment-of-inertia.md): `I = mr²`. A larger `r` means a larger `I`, which is harder to rotate but generates more tip speed per degree of rotation. A smaller `r` means a smaller `I`, which is easier to rotate (higher `ω` achievable) but requires more rotational speed to match the same tip velocity.

The practical implication: straight-arm players need a high-quality [X-Factor](../technique/x-factor.md) and [Non-Hitting Arm](../technique/non-hitting-arm.md) tuck to generate the `ω` that their long lever demands. Double-bend players can achieve the same tip speed with a less extreme `ω` because their smaller `r` makes high `ω` easier to reach.
...
- High X-Factor [X-Factor](../technique/x-factor.md) and [Non-Hitting Arm](../technique/non-hitting-arm.md) tuck quality to generate sufficient `ω` for the long lever
...
### ISR Efficiency
The double-bend allows more explosive [Internal Shoulder Rotation](../technique/internal-shoulder-rotation.md). Because the arm is closer to the body (smaller `I`), the shoulder can rotate at a higher `ω` — the ISR burst is amplified by the reduced moment of inertia at the arm.
...
- [Conservation of Angular Momentum](../technique/conservation-of-angular-momentum.md)
- [Moment of Inertia](../technique/moment-of-inertia.md)
- [Tangential Velocity](../technique/tangential-velocity.md)
- [Internal Shoulder Rotation](../technique/internal-shoulder-rotation.md)
- [Double Pendulum](../technique/double-pendulum.md)
- [X-Factor](../technique/x-factor.md)
- [Non-Hitting Arm](../technique/non-hitting-arm.md)
