...
When a player executes a proper unit turn and achieves a good [Separation Angle](../technique/separation-angle.md), the hitting arm is held back while the hips begin to open. This creates a deep stretch across the pectoral muscles, the anterior deltoid, and the obliques. When the brain signals the release, these stretched muscles contract explosively, firing the arm forward with much greater velocity than could be achieved through concentric muscle contraction alone.
...
- [Separation Angle](../technique/separation-angle.md)
