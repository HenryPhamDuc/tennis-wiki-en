...
It is the temporal dimension of [Process Focus](process-focus.md), and the mental skill most directly disrupted by [Performance Anxiety](../technique/performance-anxiety.md), which is inherently either past-oriented (dwelling on errors) or future-oriented (fearing outcomes).
