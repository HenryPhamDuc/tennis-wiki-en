...
It is the primary cognitive antidote to outcome-driven [Performance Anxiety](../technique/performance-anxiety.md), and the mental skill that separates players who perform under pressure from those who collapse.

---

## Why Outcome Focus Fails

Players who fixate on winning or losing trigger a self-defeating paradox. The pressure to achieve the outcome activates [Self 1 and Self 2](self-1-and-self-2.md) — the conscious mind intervenes in automatic execution, producing the exact technical failures the player fears.
...
The formal version of process focus is the replacement of result goals (winning the game) with process goals (executing a specific action). Process goals are entirely within the player's control, which lowers [Performance Anxiety](../technique/performance-anxiety.md) and quiets [Self 1 and Self 2](self-1-and-self-2.md).
