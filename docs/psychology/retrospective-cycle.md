...
Implement a "3-Question Review" after every match:
1. What worked well?
2. What system broke down under pressure?
3. What is the single highest-priority fix for the next practice?
Logging these answers over time reveals the true weaknesses in a player's game.

## Related Concepts
- [5-Year Tennis Mastery System](../technique/5-year-tennis-mastery-system.md)
- [Micro-Chunking Protocol](../technique/micro-chunking-protocol.md)
