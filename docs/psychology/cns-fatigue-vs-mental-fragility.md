---
title: "CNS Fatigue vs Mental Fragility"
language: en
...
A player who is CNS-fatigued shows:
- Declined serve velocity and spin
- Slower first-step reactions
- Shot patterns that default to habit rather than optimal choice
- Emotional reactivity at errors
- Decision-making that feels rushed or unclear

A player who is mentally fragile (rested, but psychologically underdeveloped) shows:
...
| **Mental Fragility** | [Satori State](satori-state.md) environment design; [Between-Point Ritual](between-point-ritual.md); pressure inoculation | Additional training volume |

The CNS Fatigue intervention is physiological: the [Performance Cliff](../biomechanics/performance-cliff.md) article's recovery protocols (sleep, nutrition, HRV monitoring) apply directly.
...
The subjective "feel" metric is unreliable for CNS assessment because:
- CNS fatigue produces an emotional/cognitive flatness that players often interpret as "I'm just not motivated today" rather than "I am physiologically underprepared"
- Competitive players tend to override fatigue signals out of commitment to training — producing a CNS debt that accumulates until performance cliff is reached
- The HRV measurement removes the subjectivity: the number is the number
...
- [Performance Cliff](../biomechanics/performance-cliff.md)
- [HRV Load Management](hrv-load-management.md)
- [Satori State](satori-state.md)
- [Sleep and Neurological Recovery](../biomechanics/sleep-and-neurological-recovery.md)
- [Between-Point Ritual](between-point-ritual.md)
- [Self 1 vs Self 2](self-1-vs-self-2.md)
- [Coaching Methodology — Old Knowledge vs New Knowledge](../technique/coaching-methodology-—-old-knowledge-vs-new-knowledge.md)
