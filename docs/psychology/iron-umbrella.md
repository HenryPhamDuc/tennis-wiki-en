...
The break point is the moment gamesmanship is most likely to be deployed and most likely to succeed if the Iron Umbrella is not pre-built. The opponent has maximum incentive to disrupt, and the player is already facing the [Amygdala Trigger and Neural Reversion](../technique/amygdala-trigger-and-neural-reversion.md) cascade from the score alone.
