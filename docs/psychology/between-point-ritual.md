...
The structured sequence of physical and attentional behaviors a player performs in the gap between points — functioning as a neurological gating mechanism that prevents the [Amygdala Hijack](../technique/amygdala-hijack.md) from persisting into the next execution window.
...
Specific examples:
- **Novak Djokovic's** high ball-bounce count before serving
- **Rafael Nadal's** bottle alignment and pre-serve sequence
