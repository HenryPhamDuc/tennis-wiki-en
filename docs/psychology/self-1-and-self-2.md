...
[Performance Anxiety](../technique/performance-anxiety.md) is largely the story of Self 1 interfering with Self 2.
...
**On double faults**: The Self 1 worry about double-faulting does not prevent double faults — it activates the anxiety response that creates the grip tightening and swing abbreviation that produces them. Self 1 is the primary activator of [Petit Bras](../technique/petit-bras.md).

**On process**: Self 1 is the mechanism by which anxiety about outcome displaces [Process Focus](process-focus.md). It generates the "what if" thoughts — what if I lose this game, what if I double-fault here — that pull attention away from the present execution task.
...
Strategies for quieting Self 1:
- **[Process Focus](process-focus.md)**: occupy Self 1 with a constructive tactical goal, leaving no room for outcome anxiety
- **[Present Moment Focus](present-moment-focus.md)**: prevent Self 1 from dwelling on past errors or projecting future scenarios
- **[Between-Point Reset Ritual](between-point-reset-ritual.md)**: interrupt the feedback loop before Self 1 can stack arousal
- **[Mushin](mushin.md)**: the philosophical framework for achieving a no-mind state in which Self 1 is structurally silent
