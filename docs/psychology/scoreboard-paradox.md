...
When Self 1 obsesses over the scoreboard — "I must win this break point" — it shifts the nervous system into threat mode (see [Amygdala Trigger and Neural Reversion](../technique/amygdala-trigger-and-neural-reversion.md)). The body braces for the result.
