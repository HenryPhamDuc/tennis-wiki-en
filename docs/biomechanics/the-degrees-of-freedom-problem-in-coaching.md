---
title: "The Degrees of Freedom Problem in Coaching"
language: en
...
**Physical constraint examples**:
- A **cone placed directly behind the player's front hip**: as they swing, the hip must clear the marker. The external reference makes hip clearance immediately self-correcting — the player discovers the sensation of clearing the hip without being told what it is or why it matters
- A **wall preventing backswing overreach**: makes an oversized backswing physically impossible; the optimal compact preparation becomes the only available choice
- A **resistance band on the non-dominant wrist**: creates proprioceptive feedback that makes the counter-balance timing visceral rather than instructional
...
The correct progression for constraint-based coaching:
1. Use the physical constraint until the motor pattern stabilises
2. Remove the constraint
3. Ask the player to "reproduce the feeling" — access the proprioceptive memory of the correct pattern without the external reference
