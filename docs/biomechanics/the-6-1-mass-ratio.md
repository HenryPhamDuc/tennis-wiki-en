...
When this ratio governs the stroke, the kinetic chain operates as designed. When it is violated — when the arm attempts to do the work of the trunk — [Arming](../technique/arming.md) occurs and injury follows.

---

## The Principle

In optimal [Kinetic Chain](kinetic-chain.md) execution:
...
The result is the two signature arming injuries: **Infraspinatus Atrophy** (IA) and **Lateral Epicondylitis** (tennis elbow) — both detailed in [Arming Injuries](../technique/arming-injuries.md).
...
The 6:1 ratio is most directly applied at the moment of the unit turn. If the turn is performed only with the arms — no thoracic rotation — the arm has not recruited the trunk's mass advantage at all. The stroke is executing at perhaps 1/6 of its available power ceiling from the outset, regardless of how hard the arm swings.

The [Unit Turn and V-Shape Lock](../technique/unit-turn-and-v-shape-lock.md) is the mechanism that engages the trunk's mass in the stroke. Without it, the 6:1 ratio never activates.
...
- [The Arming Ratio](../technique/the-arming-ratio.md)
- [Arming Injuries](../technique/arming-injuries.md)
- [Unit Turn and V-Shape Lock](../technique/unit-turn-and-v-shape-lock.md)
- [Arming on the Volley](../technique/arming-on-the-volley.md)
