...
**Braking Failure** is the injury pattern that results when the [core](../technique/core-as-shock-absorber.md) generates rotational power correctly but cannot *stop* it cleanly after contact. The residual rotational force continues past the intended stopping point and is absorbed by spinal ligaments, facet joints, and sacroiliac joints — structures that were never designed to carry it.
...
The core has two jobs at contact:
1. **Accelerate**: Drive rotational force from hips to racket through the proximal-to-distal [Kinetic Chain](kinetic-chain.md).
2. **Brake**: Stop that rotation cleanly after the ball leaves the strings.
...
| Fix | Concentric core/hip strengthening | [Eccentric Deceleration](../technique/eccentric-deceleration.md) of trunk |
...
This is a specific application of [Eccentric Deceleration](../technique/eccentric-deceleration.md) to the trunk. The relevant training methods include:
- Rotational medicine ball "throw + catch" (receiving partner throws generate eccentric braking demand)
- Cable chop with deliberate deceleration phase
- Pallof press with anti-rotation holds
- Russian twist with deceleration control
