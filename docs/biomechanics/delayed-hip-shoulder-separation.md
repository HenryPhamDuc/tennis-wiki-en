---
title: "Delayed Hip-Shoulder Separation"
language: en
...
The stretch created by Delayed Hip-Shoulder Separation stores energy in:
- The obliques (primary rotational driver)
- The thoracolumbar fascia (the [Viscoelastic Engine](viscoelastic-engine.md)'s diagonal sling)
- The deep spinal rotators
- The serratus anterior and pectorals (chest expansion under torsional load)

When released, this energy cascades up the [Kinetic Chain](kinetic-chain.md) — hips decelerate as they transfer to the torso, torso decelerates as it transfers to the shoulder, and so on — arriving at the [Straight-Arm Forehand](../technique/straight-arm-forehand.md) contact point with the full accumulated momentum of the system.
...
- [High-Elbow Backswing](../technique/high-elbow-backswing.md)
