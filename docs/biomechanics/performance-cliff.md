...
**Impact:** Decision-making degrades. The player is less likely to choose the correct tactical shot or accurately anticipate opponent movement. The [Anticipatory Framework](../technique/anticipatory-framework.md) that was firing automatically becomes sluggish — the read comes later, the first step is slower, and the opponent's patterns are not recognised until it is too late to exploit them.
...
The recovery science chapters (see [Glycogen Window](../technique/glycogen-window.md), [Hydration and Blood Plasma Volume](hydration-and-blood-plasma-volume.md), [Sleep and Neurological Recovery](sleep-and-neurological-recovery.md)) are explicitly oriented toward delaying the cliff — keeping all three dimensions above the threshold where compensation begins.
