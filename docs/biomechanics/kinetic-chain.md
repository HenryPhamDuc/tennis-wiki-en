...
A tennis stroke is a wave of energy. It begins with [Ground Reaction Forces (GRF)](../technique/ground-reaction-forces-(grf).md) as the legs push against the court. This force travels upward through the knees and hips, initiating the [Pelvic Snap](../technique/pelvic-snap.md). The energy then transfers through the core via the [Separation Angle](../technique/separation-angle.md), accelerates the shoulders, flows down the relaxed arm, and finally whips the racquet head through the ball. If the sequence is perfectly timed, the power is effortless.
...
| Stiffness | Over-tensing muscles in the torso or arm | Prevents the fluid transfer of energy; destroys [Rhythm & Relaxation](../technique/rhythm-&-relaxation.md) |
...
- [Pelvic Snap](../technique/pelvic-snap.md)
