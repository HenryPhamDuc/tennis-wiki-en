...
Trước mỗi điểm, [Blueprint Champion](blueprint-champion.md) thực thi một mini-sequence planning:
- **Đọc vị trí đối thủ**: Return position, dominant patterns, fatigue signals.
- **Chọn pattern**: Từ [3-Shot Pattern Design](../technique/3-shot-pattern-design.md) được thiết kế trước trận.
- **INTENTION**: Xác định rõ mục tiêu của điểm này.
- Sau đó: **không còn tactical thinking** trong khi đánh — [Satori State](../psychology/satori-state.md) tiếp quản.

### Trong Điểm — Non-Interference
Khi điểm bắt đầu, Blitz-Chess architecture đã set up context. Execution là việc của [Martial-Agentic Framework](../technique/martial-agentic-framework.md)'s Agentic side — Satori state. Mọi in-point "thinking" là can thiệp vào Self 2 (basal ganglia), làm giảm speed và precision.

### Disguised Variety — Vũ Khí Chủ Động
[Blueprint Champion](blueprint-champion.md)'s tactical signature chỉ định: variety được triển khai **proactively** tại thời điểm đối thủ đang ở maximum rotational rhythm — không phải defensively khi mình đang bị ép. Đây là Blitz-Chess thinking: nhận ra **khi nào** đối thủ dễ bị bất ngờ nhất và tấn công vào thời điểm đó, không phải khi mình tiện.
...
|---|---|---|
| **Reactive** | Quyết định trong điểm dựa trên từng bóng | Decision fatigue, [Satori State](../psychology/satori-state.md) bị phá vỡ, inconsistency |
...
Manual tổng hợp [Blueprint Champion](blueprint-champion.md) tactical signature từ hai nguồn:
...
Hai cái này cộng lại: Sinner's depth (biết rất nhiều pattern) + Federer's speed (lựa chọn và commit nhanh) = [Blueprint Champion](blueprint-champion.md) tactical intelligence.
