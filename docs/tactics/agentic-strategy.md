...
This is why the [Plus-One Principle](../technique/plus-one-principle.md) is central to agentic play: it extends the planning horizon from "how do I hit this ball?" to "what do I do with the ball after this one?"
...
- [Sneak Attack](../technique/sneak-attack.md)
